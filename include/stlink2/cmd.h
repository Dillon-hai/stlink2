...
enum stlink2_cmd_debug {
	...
	STLINK2_CMD_DEBUG_JTAG_DRIVE_NRST       = 0x3c,
	STLINK2_CMD_DEBUG_JTAG_WRITEDEBUG_32BIT = 0x35,
	STLINK2_CMD_DEBUG_JTAG_READDEBUG_32BIT  = 0x36,
	STLINK2_CMD_DEBUG_SWD_SET_FREQ          = 0x43
};

enum stlink2_cmd_debug_jtag_drive {
	STLINK2_CMD_DEBUG_JTAG_DRIVE_NRST_LOW   = 0x00,
	STLINK2_CMD_DEBUG_JTAG_DRIVE_NRST_HIGH  = 0x01,
	STLINK2_CMD_DEBUG_JTAG_DRIVE_NRST_PULSE = 0x02
};
